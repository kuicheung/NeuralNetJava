...
public class Network implements Serializable{
	...
	public Network(String name,DataSource source){
		this.source = source;
		this.name = name;
		...
		testError = 100;
		this.jointsIndex = source.getJointIndex();
	...
	public void train(){
		...
		do {
			...
			epoch++;
		} while(epoch < 50000 && train.getError() > 0.00000001);
	...
	public double compute(Map<Integer,Double[]> scores){
		...
		double score = Math.round(normScore);
		return score;
	}
